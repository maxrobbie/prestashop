...
class ModulereferenceReferModuleFrontController extends ProductListingFrontController
{
    public $php_self = 'refer';
    ...
    {
        parent::initContent();
        $this->doProductSearch('catalog/listing/refer', ['entity' => 'refer']);
	}
